    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='CreatedBy', to='users.User', verbose_name='作成者')),
                ('sample_10', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sample_10', to='users.User', verbose_name='サンプル項目10_選択肢（マスタ連動）')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='UpdatedBy', to='users.User', verbose_name='更新者')),
            ],
            options={
                'verbose_name': 'サンプル',
